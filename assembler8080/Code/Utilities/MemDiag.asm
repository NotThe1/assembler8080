...
;
CCTRL		EQU	02H	;CONSOLE COMMAND/STATUS PORT	- 010H
CDATA		EQU	01H	;CONSOLE DATA PORT				- 011H
...
;
INIT:
;	LXI	H,01000H	;SET DELAY COUNT FOR 6850 SETTLE TIME
;DELAY:	DCX	H
;	MOV	A,H
;	ORA	L
;	JNZ	DELAY
...
MNTR:	LXI	SP,STACK
	CALL	CRLF
	MVI	C,DASH	;OUTPUT PROMPT (CHARACTER)
	CALL	CO
...
LER:	CALL	CRLF	;KEEP IT NEAT
	MVI	C,QMARK	;LINE INPUT ERROR,OUTPUT "?" TO CONSOLE
	CALL	CO
	JMP	MNTR
;
;
...
MENU:	LXI	H,DFMSG	;OUTPUT "TEST "ALL","SELECT",OR "MONITOR" (Y OR N)?"
	...
	CALL	MSG
	CALL	CECHO	;GET THE ANSWER
	CPI	ASCIIA	;"ALL" CHOSEN?
	JZ	ALL
	CPI	ASCIIS	;"SELECT" CHOSEN?
	JZ	SEL
	CPI	ASCIIM	;"MONITOR" CHOSEN?
	JZ	MNTR
