...
CodeStart:
	...
	LXI	DE,fcb2				; source of move 
	LXI	HL,dfcb				; destination fcb 
MoveFCB:
	LDAX	DE				; source fcb 
	INX	DE				; ready next 
	MOV	M,A				; dest fcb 
