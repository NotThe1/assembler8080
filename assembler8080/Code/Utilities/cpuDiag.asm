...
;************************************************************
;
OKCPU:	DB	CTRL_L,CR,LF,' CPU IS OPERATIONAL$'
;
NGCPU:	DB	CTRL_L,CR,LF,' CPU HAS FAILED!    ERROR EXIT=$'
;
;
;
;************************************************************
...
;
	...
	MVI	L,TEMP0	;	(TEMP0 AND 0FFH)	LOW BYTE OF TEST MEMORY LOCATION
	MOV	M,B
	MVI	B,000H
	MOV	B,M
	MVI	A,044H
