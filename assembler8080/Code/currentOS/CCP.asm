...
CcpStart:
	...
	MOV		A,C
	ANI		LO_NIBBLE_MASK					; disk number in accumulator
...
; disk read is ok, transfer to commandBuffer
	...
	LXI		HL,DMABuffer
	MVI		B,cpmRecordSize					; number of bytes to Copy
	CALL	CopyHL2DEforB
...
IntrinsicFunction1:
	MOV		A,C
	CPI		IntrinsicFunctionCount
	RNC										; exit if done
	LXI		DE,commandFCB+1					; beginning of name
	MVI		B,iFunctionNameSize				; length of match is in b
IntrinsicFunction2:
	LDAX	DE
	CMP		M								; match?
